...
var fetchAndSaveWalletNfts = function fetchAndSaveWalletNfts(user) {
  ...
  return new Promise(function (resolve, reject) {
    try {
      solRayz.getParsedNftAccountsByOwner({
        publicAddress: new web3_js.PublicKey(user.walletAddress),
        connection: new web3_js.Connection(global.config.solana_network, "confirmed")
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return axios__default["default"].get("".concat(nft.data.uri).concat(lastChar !== "/" ? "/" : null));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 2;
            _context.next = 5;
            return jwt__default["default"].verify(authToken, global.config.jwt_secret);
