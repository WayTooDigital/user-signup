...
var NonceModel = mongoose.model("Nonce", nonceSchema, "nonces");
...
router$2.post("/", body(["walletAddress"]).not().isEmpty(), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(req, res) {
...
router$1.post("/", body(["message", "signedMessage"]).not().isEmpty(), /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(req, res) {
    var _$exec, _$exec2;
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 14:
            _context.prev = 14;
            verified = nacl.sign.detached.verify(naclUtil.decodeUTF8(req.body.message), Uint8Array.from(req.body.signedMessage), bs58.decode(walletAddress));
            _context.next = 21;
            break;
